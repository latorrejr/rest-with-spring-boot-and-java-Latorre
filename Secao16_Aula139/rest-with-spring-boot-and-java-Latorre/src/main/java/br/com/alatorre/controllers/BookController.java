...
import br.com.alatorre.util.MediaType;
...
public class BookController {
	...
	description = "Adds a new Book by passing in a JSON, XML or YML representation of ...",
	tags = {"People"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200",
			content = {
	...
	@PutMapping(produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YML }, consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YML })
	@Operation(summary = "Updates a Book", description = "Updates a Book by passing in a JSON, XML or YML representation of ...",
	tags = {"People"},
	responses = {
